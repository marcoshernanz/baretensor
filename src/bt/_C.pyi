...
class Tensor:
    ...
    def requires_grad(self, arg: builtins.bool, /) -> None: ...

    def set_requires_grad(self, requires_grad: builtins.bool) -> Tensor: ...
    ...
    def sum(self, dim: object | None = None, keepdim: builtins.bool = False) -> Tensor: ...

    def mean(self, dim: object | None = None, keepdim: builtins.bool = False) -> Tensor: ...

    def max(self, dim: object | None = None, keepdim: builtins.bool = False) -> Tensor: ...
...
def full(shape: Sequence[int], fill_value: float, dtype: DType = DType.float32, requires_grad: builtins.bool = False) -> Tensor: ...

def zeros(shape: Sequence[int], dtype: DType = DType.float32, requires_grad: builtins.bool = False) -> Tensor: ...

def ones(shape: Sequence[int], dtype: DType = DType.float32, requires_grad: builtins.bool = False) -> Tensor: ...
...
def tensor_from_numpy(array: object, dtype: DType, requires_grad: builtins.bool = False) -> Tensor: ...
