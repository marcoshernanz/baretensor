...
def zeros(
    shape: Sequence[int], dtype: DType = DType.float32, requires_grad: bool = False
) -> Tensor: ...
def ones(
    shape: Sequence[int], dtype: DType = DType.float32, requires_grad: bool = False
) -> Tensor: ...
...
def cross_entropy(
    input: Tensor, target: Tensor, ignore_index: int = -100, reduction: str = "mean"
) -> Tensor: ...
def layer_norm(
    input: Tensor,
    ...
    eps: float = 9.999999747378752e-06,
) -> Tensor: ...
